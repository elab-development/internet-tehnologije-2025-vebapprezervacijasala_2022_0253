...
async function main() {
    ...
    try {
        await db.transaction(async (tx) => {
            // 1. ULOGE (Osnova za korisnike)
            const uloge = await tx.insert(Uloga).values([
            ...
            await tx.insert(korisnik).values([
                {
                    ...
                    passHash: hash,
                    idUloga: "9547b7f9-c876-4d8e-b975-cf298c8a97af" // admin
                },
                {
                    ...
                    passHash: hash,
                    idUloga: "1a532d97-2a35-4884-93f0-63c1f3723786" // user
                }
            ]);

            // 5. SALE (Zavise od Tipa Sale)
            ...
            // 6. SALA-OPREMA (Zavisi od Sale i Opreme)
